...
:cli-swagger (
    ...
    docker exec -ti %PROJECT_NAME%-dotnet-server bash -l -c "[ -f ".config/dotnet-tools.json" ] && dotnet tool restore || dotnet new tool-manifest --force && dotnet tool install swashbuckle.aspnetcore.cli --version 6.0.7"
